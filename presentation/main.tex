...
\title{Nutricsor Decision Model}
\subtitle{Results and Analysis}
\author[Mohamed Abidar, Samuel Chapuis]{M.~Abidar \and S.~Chapuis}
...
\input{sections/data_presentation.tex}
\input{sections/user_interface.tex}
\input{sections/electre.tex}
\input{sections/weight_summ.tex}
\input{sections/random_forest.tex}
